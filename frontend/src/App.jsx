  ...
  return (
    <div className="w-full max-w-2xl bg-gradient-to-br from-zinc-800 to-zinc-900 border border-zinc-700 rounded-xl p-6 sm:p-10 shadow-2xl shadow-indigo-600/10">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-zinc-400 text-base sm:text-lg">Your presentation code is ready!</p>
      </div>

      {/* Short Code Section */}
      <div className="bg-zinc-700 p-4 rounded-lg mb-6">
        <p className="text-sm text-zinc-400 mb-2">Access on another device:</p>
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <div className="flex-1 w-full text-center px-4 sm:px-6 py-3 sm:py-4 bg-zinc-900 border-2 border-indigo-600/30 rounded-lg">
          ...
          <button
            onClick={handleCopy}
            className="w-full sm:w-auto px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg shadow-indigo-600/30"
          >
      ...
      {viewerUrl && (
        <div className="bg-zinc-700 p-4 rounded-lg">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-sm text-zinc-400">Direct Viewer Link</p>
          </div>
          <div className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              value={viewerUrl}
              readOnly
              className="flex-1 px-3 py-3 bg-zinc-900 border border-zinc-600 rounded-lg text-zinc-300 text-sm font-mono overflow-x-auto whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-indigo-600"
            />
            <button
              onClick={handleCopyLink}
              className="w-full sm:w-auto px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 whitespace-nowrap"
            >
              <div className="flex items-center justify-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
      ...
      <div className="mt-6 text-center">
        <p className="text-xs text-zinc-500">
          All presentations expire in 24 hours • Anonymous • Secure
        </p>
      </div>
    </div>
  );
